...
import 'package:flutter_social_media_app/features/auth/models/delete_info_mode.dart';
...
class AuthenticationRepository {
  ...
  //Todo Getting and Saving accessId and accessToken
  ...
  Future<void> saveAccessToken(String accessToken) async {
    print("AccessToken $accessToken saving ");
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  Future<UserData> getUserData() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final jsonResponse = json.decode(trimmedResponse);
  ...
  Future<String> signUpFunction(String name, String location, String phone,
    ...
    try {
      ...
      //Todo: Add the profile picture as a file field
      final fileStream =
  ...
  Future<bool> deleteUser() async {
    try {
      ...
      await prefs.clear();
      if (response.statusCode == 200 &&
          DeleteInfo.fromJson(jsonDecode(response.body)).info == "deleted") {
        return true;
      } else {
        return false;
      }
